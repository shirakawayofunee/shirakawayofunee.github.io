window.timelineMsg = [
  ...
  {
    date: "N.F.24年<br>都市「DIS」の建設",
    text: "5つの宗主市が出資し、共同で内海周辺にDIS城を立ち上げた。移民を主な人口とするこのまちは、鉱業を礎にした。しかし、YFJの管理支配は全く宗主市の元に把握され、科学者たちはチラン博士の率いて<span>上庭</span>を秘かに成立。<br>各国はＥ.Ｄ.Ｇ.Ｅ.協定に調印し、DISとYFJ貿易を行う。"
  },
  {
    date: "N.F.25～60年<br>涅槃集団",
    text: "五つの宗主市は輸出を引き続き独占し、食糧の値上げなどの手段でDIS本土の富を奪い取った。<br>宗主市内部での衝突もアップし、妥協として共に<span>涅槃集団</span>を設立した。"
  },
  {
    date: "N.F.61年12月26日<br>",
    text: "民選議長DISは暗殺され、ブローク上尉は逃亡し、砂海遊撃隊を結成宗主市と対抗。"
  },
  {
    date: "N.F.62年",
    text: "各宗主都市間で激しい貿易衝突が発生し、それに対する涅槃集団の行動が反乱と見なされる。"
  },
  {
  ...
  {
    date: "N.F.66年8月27日",
    text: "ブローク上尉の呼びかけに応じ、ディス軍内で兵変が起こり、砂海遊撃隊への参加を宣言しました。"
  },
  {
    date: "N.F.66年9月15日",
    text: "ブローク上尉は独立を訴える演説を行い、ディス独立軍の結成を正式に宣言しました。同日夜、ブローク上尉は3ヶ月前に受けた放射能汚染により不帰の客となり、<span>デレヴァン・スティール</span>が独立軍の統帥権を引き継ぎました。"
  },
  {
    date: "N.F.66年～72年",
    text: "「DIS」独立戦争。"
  ...
  {
    date: "N.F.72年12月26日",
    text: "DIS独立戦争が勝利を収めた。独立軍の統率者デレヴァンの宣言のもと、ディスは正式に独立を果たしました。彼自身も新ディスの初代議長の職務を引き受けました。"
  },
  {
    date: "N.F.76年",
    text: "<span>幼少期のL</span>は両親が前線で戦死した後、親族や友人の養子縁組の申し出をすべて拒否し、復讐を誓って福音地に身を投じました。それ以来、Lは福音地において<span>最も鋭い刃</span>となりました。"
  },
  {
    date: "N.F.81年",
    text: "都市の拡大に伴い、DISは東西二区に分割された。鉱業の大部分は西区に集中している。"
  },
  {
    date: "N.F.72年～84年",
  ...
  {
    date: "N.F.84年",
    text: "DISがある実験の失敗により<span>内海大爆発</span>を引き起こした。これにより、最初の黒環<span>BR-000</span>が誕生。内海大爆発と合わせ、直接的な死者数は87231人に上った。YFJの生産量を急減させ、国外へのYFJ輸出が大幅に減少した。"
  },
  {
    date: "N.F.84年12月22日",
    text: "内海大爆発事件後、ディス旧軍の権威体制は完全に崩壊した。EDGE-01の説得を受け、残存する軍政体系は枠組み再構築計画を始動し、災害復興および防災を統括する機関の設立を提案した。これにより、<span>FAC</span>（Framework Against Catastrophe）が正式に発足。デレヴァン・スティールが初代総司令を兼任し、ディス軍の主力を狂厄への抵抗へと大きくシフトさせた。"
  },
  {
    date: "N.F.84年",
    text: "わずか6歳の<span>Severo</span>は家族を失い、行き場を失った末に福音地に拾われ、<span>Leopoldを師と仰ぎました</span>。"
  },
  {
    date: "N.F.103年",
  ...
  {
    date: "N.F.103年10月",
    text: "69歳のデレヴァン・スティールは████によって殺害されました。第二代FAC総司令にはアドリアン・スターリングが就任しました。"
  },
  {
    date: "N.F.113年",
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    if (timelineScrollable.scrollHeight <= timelineScrollable.clientHeight) {
      console.warn('Warning: Content height is not enough to trigger scrolling!');
    }
    ...
    timelineScrollable.addEventListener('wheel', (event) => {
      ...
      console.log('Wheel scroll triggered, deltaY:', event.deltaY);
    }, { passive: false });
    ...
    timelineScrollable.addEventListener('mousedown', (event) => {
      if (event.target.closest('#timelineScrollable')) {
        isDragging = true;
    ...
    document.addEventListener('mousemove', (event) => {
      if (isDragging && event.target.closest('#timelineScrollable')) {
        event.preventDefault();
