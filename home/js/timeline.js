window.timelineMsg = [
  ...
  {
    date: "N.F.72年12月26日",
    text: "DIS独立戦争が勝利を収めた。独立軍の指導者デレヴァン・スティールの宣言のもと、ディスは正式に独立を果たしました。彼自身も新ディスの初代議長の職務を引き受けました。"
  },
  {
    date: "N.F.81年",
  ...
  {
    date: "N.F.84年",
    text: "DISがある実験の失敗により<span>内海大爆発</span>を引き起こした。これにより、最初の黒環<span>BR-000</span>が誕生。内海大爆発はYFJの生産量を急減させ、国外へのYFJ輸出が大幅に減少した。内海大爆発と合わせ、直接的な死者数は87,231人に上った。"
  },
  {
    date: "N.F.84年12月22日",
    text: "内海大爆発事件後、DIS旧軍の権威体制は完全に崩壊した。EDGEの支援のもと、残存する軍政体系は枠組み再構築計画を始動し、災害復興および防災統括機関の設立草案を提案。<span>FAC</span>（Framework Against Catastrophe）が正式に発足した。"
  },
  {
    date: "N.F.84年12月22日",
    text: "内海大爆発事件後、DIS旧軍の権威体制は完全に崩壊した。EDGEの支援のもと、残存する軍政体系は枠組み再構築計画を始動し、災害復興および防災統括機関の設立草案を提案。<span>FAC</span>（Framework Against Catastrophe）が正式に発足した。"
