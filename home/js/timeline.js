window.timelineMsg = [
  ...
  },
  {
    ...
    text: "5つの宗主都市が出資し、内海周辺を半植民地的なYFJ生産地とする。<br>禁域は、EDGEを基礎に新しい都市として独立し、YFJの発掘を開始した。旧黒環禁止区域はゆるやかに安定期に入ると、内海に姿を変え、世界で唯一のYFJの鉱区となる。<br>宗主都市との駆け引きと資金争奪の末、妥協として涅槃集団が設立される。"
  },
  {
  ...
  {
    date: "N.F.84年12月22日",
    text: "内海大爆発事件後、Dis旧軍の権威体制は完全に崩壊した。EDGEの支援のもと、残存する軍政体系は枠組み再構築計画を始動し、災害復興および防災統括機関の設立草案を提案。FAC（Framework Against Catastrophe）が正式に発足した。"
  },
  {
    date: "N.F.113年",
