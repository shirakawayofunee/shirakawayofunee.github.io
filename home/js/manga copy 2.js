...
const mangaData = {
    ...
    2: { title: "第二章：觉醒",         images: ["img/manga/c2/01.jpg","img/manga/c2/02.jpg","img/manga/c2/03.jpg","img/manga/c2/04.jpg"] },
...
function loadMangaChapter(chapterId) {
    ...
    mangaSwiper = new Swiper(".mangaSwiper", {
        ...
        allowTouchMove: true,
        navigation: {
            nextEl: ".manga-btn-prev",   // RTL 模式下左箭头是“下一页”
            prevEl: ".manga-btn-next",   // 右箭头是“上一页”
        },
        on: {
            slideChange: () => updatePagination(data.images.length)
        }
    });
