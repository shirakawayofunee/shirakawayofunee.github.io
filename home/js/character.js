let characterMsg = [

  {
    ...
    },
    {
      ...
      check: "9c.png",
      title: "9t.png",
      str: "上庭からXを協力（監視）するために派遣された代理人。Sの尋問中、逃げられてしまった。<br>冷酷で機械的、典型的な上庭の官僚像を体現しており、任務の効率を最優先し、一般人の命や感情を軽視する。<br>上庭的高级代表，负责监督x并处理S的审查。<br>冷酷、机械，典型的上庭官僚形象，重视任务效率，漠视普通人的生命和情感。<br>虚伪、傲慢、狂妄、残忍。道貌岸然的一群人，<br>未完成",
