let characterMsg=[
    ...
    {
        bg: "5bg.png",
        role1: "5-1.png", // 静态立绘1（如戴帽子）
        role2: "5-2.png", // 静态立绘2（如不戴帽子）
        nocheck: "5.png",
        check: "5c.png",
        title: "5 Robinhood (50%) 50%),
        str: "「個人の意思よりも命令。<br>…昔、そう教えられました」",
      },
    {
        bg:"9bg.png",
...
function changeCharacter(num) {
    ...
    // 显示静态立绘，隐藏 Live2D 相关元素
    $("#roleImg").show().prop("src", `./img/role/${data.rolem}`);
    ...
    playCharacterVioce(2); // 停止语音

    // 禁用 Live2D 按钮，显示为已选中状态
    $("#roleLive").hide();
    $("#roleLiveing").show();
