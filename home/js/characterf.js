let characterMsg = [

  {
    ...
    str: `
      能力者、178cm。<br>
      犯罪組織の主宰者であり、部下たちから恐れられ、崇拝されている存在。<br>
      年齢と比べてあまりにも<span>若々しい顔立ち</span>、過度に白い肌色――虞美人の時間は、遠い遠い昔に完全に止まってしまったかのようだ。実年齢不明、60>？？>36。<br>
      艶やか、常に世を拗ねるような微笑を浮かべている。
      <br>好き嫌いが激しく、享楽主義者で実用も重んじる、細やかで優しい一面も持っている。<br>
      落ち着き払った自信に満ちていて、自信かつ優雅な態度を保ち、性格は八方巧み。夹缝中的最强者，将上庭与地底的斗争视作狗咬狗。当前的目标是在自己死前，给下属们寻求新的安全居所。<br>
      ▍人間単体の最強戦力<br>
      核兵器＞＞＞L≈使徒≥軍隊＞一般能力者＞＞力強いたくましい人間＞一般人<br>
      ▍好きなもの<br>
      ...
      特技……開花、癒し<br>
      ▍背景<br>
      Lは幼少期、軍人である両親が前線で命を落としました。その命の価値のない犠牲は「崇高な使命のため」とされましたが、彼女にとってその言葉は無意味で、むしろ規則の虚偽と束縛を感じさせるものでした。両親の死は彼女に反抗心を芽生えさせ、彼女は規則に縛られることを拒み、命を代償に禁断の力と契約を結びました。その力を使って、他の人々が規則から解放され、彼女のように自由に生きる手助けをすることを決意します。<br>
      ▍会話例<br>
    ...
    },
    {
      ...
      check: "7c.png",
      title: "7t.png",
      str: `独立軍第二代統帥、新城邦初の民選議長、FACの創設者にして初代総司令――デレヴァン・スティール。<br>
      軍人として、彼の特質は揺るぎない信念、果断な行動、忠誠心、決して退かない姿勢、そして手段を選ばない覚悟だった。<br>
      こうした妥協なき戦士だけが、ディスを絶望の淵から導き、勝利へと押し上げることができた。
      しかし、これらの特質は政治の舞台では彼の弱点となった。
      政治には円滑さ、妥協、そして人心を操る術が必要だが、デレヴァンの剛直な性格はそれと相容れなかった。<br>
      蛀虫たちは権力欲と富で彼の同志を腐らせ、陰謀と策略で彼の兵士を蝕み、腕を切り落とし、目を覆い、権力を奪い、威信を崩し、彼を孤立させ、
      誰もが背を向けるように仕向けた。彼は妥協を拒み、必死に抗ったが、罠にはまるばかりだった。
      彼は偏執的な独裁者へと変わり、敵と味方、正と誤を見分けられなくなり、道を踏み外し、策は誘導され、利用されていることに気づかず、
      正義の軍は不義の戦犯へと堕した。<br>
      理想を胸に抱いた男は打ち砕かれた。信仰は城邦の腐敗したルールを変えられず、人々の尽きない貪欲を変えられず、繰り返される歴史の法則を変えられなかった。
      <br>▍詳細<br>
      新ディスが建国されると、商人、投機者、政客たちが我先にと押し寄せ、政治闘争に長けた異邦の勢力がこの若い城邦に潜り込み、経済の命脈を握った。
      デレヴァンは愛する城邦がこのような輩に穢されるのを許せず、戦時だけが彼に一時的な権威を与えた。<br>
      そこで内なる矛盾をそらすため、彼は外へ向けて拡張を繰り返し、内部では軍を統治する手法で城邦を治めようとした。
      だが、この選択は彼の初心を徐々に逸らし、孤立させ、狂気へと追いやった。<br>
      旧時代の蛀虫たちは、新たな功臣たちに勝利の果実を味わう術を教え、汚濁に染まることを拒んだ者たちは次々と排除された。
      最初に死んだのはヴィクトール。政治的頭脳はあったが戦は不得手で、前線に送られ、そのまま「戦死」した。<br>
      結束の要を失い、残された兵士たちは次々と腐敗し、瓦解した。
      最も清廉潔白だったアドリアンは最後まで信念を貫いたが、意味をなさなかった。信頼されない忠臣に価値はない。<br>
      デレヴァンは元来、政治的指導の経験に乏しく、一人の力で城邦内部の腐敗の毒瘤に対抗することはできなかった。
      だが、彼の側近はすでに分断されていた。
      彼が支援を必要とすればするほど、心に邪念を抱く者たちが寄ってきて、彼を誤った方向へ誘導し、反対されればされるほど勝とうとした。
      それが彼の性格だった。失敗を認めず、決して妥協しない。だからこそ、彼は死のループに陥ったのだ。",
      `,
      image1: "7-1.png",
      image2: "7-2.png",
