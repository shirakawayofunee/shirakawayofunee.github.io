 ...
 * @LastEditTime: 2025-07-01 15:19:47
 * @Description:
...
var backstoryStr = [
  ...
  <br>L「もっともらしいことばかり言って、結局は臆病者じゃないか？臆病なだけじゃなく、偽善的で、傲慢で、狂妄で、残酷だ。自分を何だと思ってるんだ？！」  
  <br>
  X「そう、それが上庭だ。必死で真実や正解を追い求めながら、リスクや未知のものを恐れ、災厄が再び訪れるのを怯えている。あれこれルールや保険を作ってすべてを防ごうとするけど、そのせいで自分も、皆も、死路に追い込んでいるだけだ。」
    `,
