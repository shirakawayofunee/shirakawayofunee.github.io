 ...
 * @LastEditTime: 2025-07-01 00:33:25
 * @Description:
...
var backstoryStr = [
  ...
  <br>「██」に侵された多くの人々の中で、極めて少数、「能力者」と呼ばれる個体が異常な危険能力を獲得した。彼らは狂気や偏執といった一般的な症状を示しながらも、自我意識を保持でき、怪物にならなかった。<br>「人類は闇の中で耐え抜き、必ず再び訪れる夜明けを待つ。」
    `,
  ...
  西区は強者が弱者を貪る無法地帯へと変貌した。死亡者数は公開されず、同時に「能力者」の数が急増した。
    `,
  `「福音地」，「上庭」的老对头。<br>「花园」的大客户之一，<br>成员之间毫无关爱可言，彼此独立，生死自负。将ta们凝聚起来的是某种夙愿，能为之献身更像是一种荣誉。<br>诱骗S去送死的成员名为「シーゲル」
  `,
  `「福音地」的老对头，「上庭」<br>「D」の最上層に位置する勢力で、都市「D」を支配している。上庭不像地底那样熟练掌握狂厄。上庭眼里除了他们这群人类的救世主，其他人类都是随时可弃的必要牺牲而已。认为自己能凌驾于感情的傲慢自大，也是完全不把人当人看。讽刺的是上庭正是因为无法剥离感情，才需要制造观测者这样的工具；他们也因为无法消解的恐惧而本末倒置，为了对抗狂厄牺牲原本的保护目标人类，离初心越来越远。<br>L「虚伪、傲慢、狂妄、残忍。道貌岸然的一群人」
    `,
  `花园、中立組織。<br>変装と潜入を得意とする謎の組織。
