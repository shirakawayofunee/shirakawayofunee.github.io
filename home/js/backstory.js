 ...
 * @LastEditTime: 2025-06-23 15:34:33
 * @Description:
...
var backstoryStr = [
  ...
  <br>「██」に侵された多くの人々の中で、極めて少数、「禁閉者」と呼ばれる個体が異常な危険能力を獲得した。彼らは狂気や偏執といった一般的な症状を示しながらも、自我意識を保持でき、怪物にならなかった。
    `,
  `九十年前、「██」に対抗しうる鉱石「YFJ」が発見され、戦争が終結し、各都市は共同で協定に調印しました。
  <br>都市「D」
  <br>人口が最も多く、最も繁栄している都市。政府機関、治安維持機関、研究所、軍事部隊、外事局、工業集団といった完璧な管理体系を有しています。世界で唯一の「YFJ」採掘地として、Dは辺境協定に基づきイレギュラーキューブを採掘し、外部の都市へ輸出を開始しました。その代わりに、外部の都市から他の産業や資源の支援を受けています。  
  西区は採掘地として機能しています。  
  <br>三十年前、採掘地で大爆発が発生し、汚染が広がりました。これにより「YFJ」の採掘が困難になり、西区の採掘業は衰退しました。多くの統治機関が西区から撤退、あるいは放棄しました。西区は強者が弱者を食い物にする無法地帯へと変貌しました。死亡者数は公開されず、同時に「禁閉者」の数が急激に増加しました。  
  `,
  `介绍上庭地底，图还没想好用哪张
    `,
