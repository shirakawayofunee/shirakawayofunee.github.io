...
var backstoryStr = [
  ...
  <br>「██」に侵された多くの人々の中で、極めて少数、「能力者」と呼ばれる個体が異常な危険能力を獲得した。彼らは狂気や偏執といった一般的な症状を示しながらも、自我意識を保持でき、怪物にならなかった。“人类在黑暗中坚守，等待曙光必然再临。”
    `,
  ...
  西区は強者が弱者を貪る無法地帯へと変貌した。死亡者数は公開されず、同時に「能力者」の数が急増した。
    `,
  `「上庭」的老对头，「福音地」<br>「花园」的大客户之一，<br>成员之间毫无关爱可言，彼此独立，生死自负。将ta们凝聚起来的是某种夙愿，能为之献身更像是一种荣誉。<br>诱骗S去送死的成员名为「シーゲル」
  `,
