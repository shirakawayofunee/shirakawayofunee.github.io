 ...
 * @LastEditTime: 2025-08-08 02:47:32
 * @Description:
...
var backstoryStr = [
  ...
  Lが「GRADEN」を引き継いだ後、「GRADEN」を率いて「福音地」から独立を果たした。
  <br>
...
<br>
Lは「GRADEN」を、メンバーそれぞれ自分の目標（復讐、力、居場所など）を追い求める、個性を大胆に表現できる、
高層の「大義」や「栄光」に縛られて無理やり犠牲になることのない、Lの理想郷として作り上げた。
<br>▍組織理念<br>庇護：差別や抑圧、亡命を経験した異能者や社会の周辺にいる個人を受け入れること。出自、罪状、身分を問わず、すべての人に門戸を開きます。
<br>▍組織構造
<br>「GRADEN」唯一の絶対的権威者、主宰者、Leopold。
<br>対内では穏やか、対外では強硬な姿勢を持ち、組織の精神的支柱です。
全メンバーに対する最高の処分権限を有します。
<br>▍核心メンバー<br>Lに直接従う初期の追随者（例：Sなど）。忠誠心が極めて高く、一定の自主権を持つ。
<br>▍常駐メンバー<br>「GRADEN」の拠点に長期滞在し、情報収集、製作、後方支援、育児などの業務に従事。定期的に訓練を受ける。
<br>▍周辺メンバー<br>身分を浄化後、社会の各分野で活躍する「元「GRADEN」の人々」（例：画家の堇、アイドルマネージャーの菲露西娅など）。一部は「GRADEN」の任務を引き続き受ける。
<br>▍一時庇護者<br>一時的に保護された異能者。評価を経て常駐メンバーとなる可能性がある。制御不能な場合は追放または浄化される。
  <br>
  変装と潜入を得意とする謎の組織。
  ...
  `S最终倒下的地方。<br>
  此处产生分支：<br>
  ①レオポルドが間に合って駆けつけ、セヴェロを救い出し、次の物語へと進む。セヴェロは庭園に戻り、休息して回復する。<br>
  ②セヴェロは失血多量で死亡し、上庭が彼女を見つけたとき、すでに冷たい遺体となっていた。Xは熟考の末、レオポルドを最大限に怒らせる方法を選んだ：解体。BE<br>工事中`,
  ...
  <br>▍FAC
  <br>Dissの主要な軍事力で、上庭に直属している。黒環の活動や██事件など、災変によってもたらされた全ての状況の対応を行う。
  ...
  <br>▍危機管理局<br>能力者の収容および管理を担当する機密組織。かつてはFACに所属していたが、現在は第九機関の指揮下で██事件の対応にあたっている。
  <br>▍パルマ<br>謎の組織パルマ。西区に██武器を氾濫させた黒幕であり、多数の██事件に関与している疑いがある。
  ...
  `复古的手工匠人之店，空气中弥漫着淡淡的花香，静谧而温馨。<br>足以彰显<span class="cus-key">店主<span class="cus-target2">Severo</span></span>的品味与专业性。<br>工事中`,
    ...
    <br>▍黒環の影響
    <br>黒環は無秩序かつ大規模な██の蔓延をもたらし、内部にいる個体を怪物に異変させる。
    ...
    <br>2.同一の感情を持つ██感染者が集合して共感する。
    <br>以上の条件から判断するに、黒環の爆発には膨大かつ集中的な██汚染が必要である。集中するほど純度が高くなり、爆発後の黒環の強度も高くなる。
    爆発後の黒環は、制御を受けなければ時間の経過と共に強くなり続ける。

    <br>▍受骸者
    <br>「骸」は膨大な量の██汚染が融合した物質あるいは生物であり、復活していない状態でも人間に似た感情や意識が存在すると考えられている。
    ディスシティには複数の「骸」が存在する。「骸」が復活すると、その感情と意識はますます明瞭になってくる。復活した個体は受骸者と呼ばれ、██汚染の中心となる。
