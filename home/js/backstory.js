 ...
 * @LastEditTime: 2025-08-25 06:17:51
 * @Description:
...
<br>▍一時庇護者<br>一時的に保護された異能者。評価を経て常駐メンバーとなる可能性がある。
  ...
  <br>都市「Dis」人口が最も多く、最も繁栄している都市。政府機関、治安維持機関、研究所、軍事部隊、外事局、工業集団といった完璧な管理体系を所有している。
  世界で唯一の「YFJ」採掘地として、Disは辺境協定に基づきYFJを採掘し、外部の都市へ輸出を開始した。
  ...
  <br>▍FAC
  <br>Disの主要な軍事力で、上庭に直属している。黒環の活動や狂厄事件など、災変によってもたらされた全ての状況の対応を行う。
  <br>▍市議会<br>Disの管理期間で、都市内外の中枢的管理機能を担う。民選ではあるが、上庭の監督下にある。
  <br>▍ディス治安総局<br>Disの治安維持機関。市議会に直属し、街の治安維持を担当する。本部はニューシティにあり、管理体制も万全だが、「西区治安管理条例」によると、シンジケートに置かれた支局は治安維持機能を行使できず、一連の社会問題を引き起こしている。
  ...
  <br>▍第九機関<br>Disのスパイ組織。上庭に直属しており、極めて高い自主行動権限を持つ。
  ...
  <br>「彼らは微光が消滅した塔の上で祈る。
  <br>彼らは朽ち果てた天の高台で歌う。
  <br>彼らはようやく啓示を手に入れ、頭を下げ、地の底へ戻り、暗闇へ沈むーー忘れられた場所で星が戻るのを、王の帰還を待つ。」
  ...
  暗潮(瘟疫)、荒竭(饥饿)、靡音(死亡)、戾刃(战争)四大阵营，亦为“天启四骑士”
  <br>工事中
  `,
...
信仰	多様な神話、伝説
通貨	銅貨
    東方にある巨大な大陸。ディスシティとの交流は乏しく、ディスシティとは異なる謎めいた技術と独自の文化を持つと噂されている。
    <br>隕星落下後、残った東洲都市国家は生き残るために東洲都市連盟を築いた。
    <br>ディスシティからは遠く離れた土地だが、世界的災変の中心地であるディスシティで起こる出来事は遠方にも大きな影響をもたらし、東洲は長年、数多くの天災に見舞われてきた。
    
    <br>N.F.106年、新たな災変により東洲は大きく損害を受け、当初から乏しかったディスとの交流は途絶え、東洲は海に沈んだという噂が流れていた。
    <br>N.F.112年、ディスシティで東洲沈没と呼ばれる大型の灰の潮が発生し、いくつかの都市が破壊され、多くの土地が海に沈んだ。
    災変は鎮圧できたかと思われたが、翌年封印されていた金烏きんう使徒が封印を破りディスシティの内海へと向かう。
    <br>N.F.114年1月31日、東洲都市連盟は金烏使徒を追い、ディスシティに公式な使節、東洲使節団を送る。以降は緊迫関係を孕みながらも東洲とディスシティは交易を続けている。
    
    <br>東洲ではコンビクトは巫と呼ばれている。存在するだけで犯罪者扱いのディスシティとは異なり、邪崇と呼ばれる怪物を退け、人々から尊敬される存在である。
    ブラックリングによる狂厄汚染のない東洲で生まれた巫は、コンビクトのような精神汚染を比較的受けず、いつも先天的な霊感によって覚醒する。その性質は影響を受けた狂厄天災と近い属性になる。
    東洲はイレギュラーキューブも最新の技術も持たないが、巫はコンビクトの異能力と異なる、代々伝わってきた術式で邪崇に立ち向かうことができる。`,
];
