 ...
 * @LastEditTime: 2025-06-27 15:23:30
 * @Description:
...
var backstoryStr = [
  ...
  西区は強者が弱者を貪る無法地帯へと変貌した。死亡者数は公開されず、同時に「能力者」の数が急増した。
    `,
  `「福音地」，人类中对「██」研究最充分的组织，「上庭」的老对头。<br>「花园」的大客户之一，<br>成员之间毫无关爱可言，彼此独立，生死自负。将ta们凝聚起来的是某种夙愿，能为之献身更像是一种荣誉。<br>诱骗S去送死的成员名为「シーゲル」
  `,
  `「D」の最上層に位置する勢力で、都市「D」を支配している。
    `,
