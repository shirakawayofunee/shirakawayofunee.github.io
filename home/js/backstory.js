...
var backstoryStr = [
  `元々は「福音地」が育て上げた殺し屋組織で、メンバーは使い捨ての消耗品と見なされていました。Lが「花園」を引き継いだ後、「花園」を率いて「福音地」から離反し、独立を果たしました。
  <br>
  「よし、今日からもう私たちを縛れる者はいない。処分すべき者は皆殺しだ。もう一線を画いて、バイバイできるんだ～。今から、みな、自分の好きな仕事だけを受けて、好きな獲物だけを仕留めて、報酬をもらおう。行きたいところがあれば行け、気が向かなければ離れても構わない。誰かの指図をもう受けなくていい——私の以外はね。
恨みは君たちを縛れなくなる、私が自由をやるんだ。自分の命は、好きなように使えばいい——師匠の私が許したんだから。」
<br>
  Lは「花園」を、メンバーが個々の目標（復讐、力、帰属など）を自由に追い求め、個性を大胆に表現し、高層の「大義」や「栄光」に縛られて無理やり犠牲になることのない、Lの理想郷として形作ろうとしています。
  <br>
  S「もう二度と家族を失いたくない…」L「花園が君の家だよ。私が君に家族をあげる。」
  <br>
  J「あいつは罰を受けるべきだ！」L「なら、徹底的にやりなさい。私が教えてあげる。」
  <br>
  T「もっと強くなりたい！誰にも踏みにじられたりしない！」L「なら、私を越えるか、私を殺しなさい。」
  <br>
  L「実現しなさい、復讐しなさい！私の花、私の花園は、自由で、気ままで、思うままに育つべきもの。邪魔な雑草は、全部刈り取ってしまえばいい。」
  ...
  「私は花園の数人の殺し屋と関わったことがあるけど、彼女たちは殺人を楽しむような狂人じゃないよ。」
    `,
  `故事正式发生时，X与上庭人员所居住的度假山荘，周围全是针对「禁闭者」设下的天罗地网。<br>附近的住户、记者、议员、医生、警卫、商贩、裁缝。<br>工事中`,
  `S最终倒下的地方。<br>
  此处产生分支：<br>
  HE-L救走了Severo。<br>
