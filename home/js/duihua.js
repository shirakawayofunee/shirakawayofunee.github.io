let characterMsg = [

  {
  ...
  },
    {
      ...
      check: "2c.png",
      title: "2t.png",
      str: "36歳｜能力者｜187cm<br>第一印象は礼儀正しく、スイーツ作りに万能であり、少しユーモアのある人物。<br>穏やかな長女のような雰囲気を持ち、幼少期に経験したショックがその後の人格形成に大きな影響を与え、<br>「L＞森羅万象」という極端な価値観を抱えて生きている。家族の風邪を世界中のどんな死亡事故よりも深刻に捉えるようになった。服のボタンはすべて、亡くなった親友の遺骨を磨いて作られた骨のボタンです。<br>裏稼業…………………殺し屋<br>誕生日と命日…………………8月15日<br>▍好きなもの<br>性格……<br>逆鱗……Leopold<br>得意なこと……手芸、毒物学<br>趣味……<br>好き……Leopold、図書館、家族<br>嫌い……手続き的正義、または、遅れてやって来る正義。<br>特技……狙撃、癒し<br>▍背景<br><br>▍SとLの初対面<br>界隈内で数少ない有能な殺し屋として、Lのもとに弟子入りしたがる者は後を絶たず、みな彼女の名声に惹かれ、立派な後ろ盾を得ようと目論んでいる。だが、実際にLに教えを受ければ、疲れや苦しみ、傷つきから死ぬまで至り、どんな目に遭うかは各々の定め。だから、Lが本気で受け入れた弟子はほんのわずかだ。<br>Lは手を振って、猫や犬を呼ぶように気軽に人を呼び寄せた。Sは素直に従い、丁寧に礼をして「師匠」と呼んだ。<br>Sの謙虚な態度の下に抑えきれない憎しみが宿った瞳を見て、Lは笑った。「今の君の目、気に入ったよ。ストレートで、率直で、生きる欲望に満ち溢れている…惨めだけと運良く、愚かだけどどこか冴えていて、脆くも確固たる情熱を抱いてる。」<br>Lは████の方へ振り返り、「この子、いただくよ」と告げた。<br>(1/3)",
