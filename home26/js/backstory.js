 ...
 * @LastEditTime: 2025-08-26 08:18:13
 * @Description:
...
<br>▍一時庇護者<br>一時的に保護された異能者。評価を経て常駐メンバーとなる可能性がある。
  ...
  <br>
    `,
  `<br>詳細はタイムライン（約2000字）またはストーリー（1万字以上）をご覧ください。<br>ちなみに、←左の画像は第二章「弱者」に起こる出来事です。`,
  ...
  <br>都市「ディス」人口が最も多く、最も繁栄している都市。政府機関、治安維持機関、研究所、軍事部隊、外事局、工業集団といった完璧な管理体系を所有している。
  世界で唯一の「YFJ」採掘地として、ディスは辺境協定に基づきYFJを採掘し、外部の都市へ輸出を開始した。
  ...
  <br>▍FAC
  <br>ディスの主要な軍事力で、上庭に直属している。黒環の活動や狂厄事件など、災変によってもたらされた全ての状況の対応を行う。
  <br>▍市議会<br>ディスの管理期間で、都市内外の中枢的管理機能を担う。民選ではあるが、上庭の監督下にある。
  <br>▍ディス治安総局<br>ディスの治安維持機関。市議会に直属し、街の治安維持を担当する。本部はニューシティにあり、管理体制も万全だが、「西区治安管理条例」によると、シンジケートに置かれた支局は治安維持機能を行使できず、一連の社会問題を引き起こしている。
  <br>▍特別管理局<br>能力者の収容および管理を担当する機密組織。かつてはFACに所属していたが、現在は9thの指揮下で狂厄事件の対応にあたっている。
  <br>▍パルマ<br>謎の組織パルマ。西区に狂厄武器を氾濫させた黒幕であり、多数の狂厄事件に関与している疑いがある。
  <br>▍9th<br>ディスのスパイ組織。上庭に直属しており、極めて高い自主行動権限を持つ。
  ...
  <br>非人道的な実験を通じて普通の人々を能力者に変えるパルマ研究所。
  ...
  <br>「彼らは微光が消滅した塔の上で祈る。
  <br>彼らは朽ち果てた天の高台で歌う。
  <br>彼らはようやく啓示を手に入れ、頭を下げ、地の底へ戻り、暗闇へ沈むーー忘れられた場所で星が戻るのを、至高者の帰還を待つ。」
  `,
  `「上庭」、「福音地」の長年のライバル。
  <br>上庭はディスの最上層を統治する勢力であり、都市全体の命脈を握っている。
  その意思決定の中枢は、科学者によって設立された組織「<span>Edge</span>」であり、現在は再編を経て7人のメンバーによって構成されている。
  <br>▍管理構造
  <br>上庭の敵は狂厄だけであり、彼らはディスを導くのみで、その政治や民生には干渉しない。ただし、狂厄に対抗するための戦略的資源は、すべて上庭が掌握する必要がある。
  <br>例えば、戦闘用の<span>FAC</span>、異方晶の開発を担う<span>涅槃集団</span>、能力者を制限する<span>特別管理局</span>、特務機関<span>9th</span>。
  <br>▍
  <br>狂厄を熟知する地底とは異なり、上庭は狂厄の制御において力不足が否めない。彼らは自らを人類の救世主とみなし、他の人間を犠牲にできる駒とみなす、感情を超えた傲慢さと冷酷さを示す。
  だが、皮肉にも、狂厄への恐怖を拭えなかったがゆえに、彼らは本来の目的から逸脱し、守るべき人類を犠牲にしてまで狂厄に対抗しようとしている。
  <br>▍評価
  ...
  あれこれルールや保険を作って防ごうとするけど、自分も、皆も、その手で死に追い込まれただけ。」
    ...
    <br>▍爆心地
    <br>BR-000の後、それぞれの黒環の爆発時には、1人の強力な能力者の暴走が確認されている。その能力者は、黒環の爆心地と呼ばれる。黒環の爆発要件は、「骸」の復活である。
    ...
    `,
    `
    ディス城に次ぐ規模を誇る、知られた最大の城邦であるフェシャ城には、強大な財力を持つキャンベル家が根を張っています。
    <br>城内の政治や経済貿易といった主要な分野は、ほぼ全て<span>キャンベル家</span>によって掌握されています。
    キャンベル家の長年にわたる経営のもと、フェシャ城の貿易や物流産業は他邦の中でも非常に発展しており、経済総量はディス城に次ぐものです。
    過去の数々の戦争で、ディス城に対して<span>表面上</span>は中立かつ友好的な立場を保っていました。
    フェシャは入夜以前から莫大な富を蓄積しており、ディス城の設立にはその支援が半分を占めていたと言っても過言ではありません。
    `,
    `
東方にある巨大な大陸。ディスシティとの交流は乏しく、ディスとは異なる謎めいた技術と独自の文化を持つと噂されている。
<br>隕星落下後、残った東洲国家は生き残るために東洲都市連盟を築いた。主な産業は農業であり、貨幣は銅貨、信仰は多様な神話と伝説に基づいている。
<br>ディスからは遠く離れた土地だが、世界的災変の中心地であるディスで起こる出来事は遠方にも大きな影響をもたらし、
東洲は長年、数多くの天災に見舞われてきた。
<br>▍天災
<br>N.F.106年、新たな災変により東洲は大きく損害を受け、当初から乏しかったディスとの交流は途絶え、東洲は海に沈んだという噂が流れていた。
<br>N.F.112年、ディス内でのBR-004の爆発とともに、東洲は壊滅的な天災に見舞われ、灰烬の潮が広がった。いくつかの都市が破壊され、多くの土地が海に沈んだ。
災変は鎮圧できたかと思われたが、翌年封印されていた金烏きんう使徒が封印を破りディスの内海へと向かう。
<br>N.F.114年1月31日、東洲都市連盟は金烏使徒を追い、ディスに公式な使節、東洲使節団を送る。以降は緊迫関係を孕みながらも東洲とディスは交易を続けている。
<br>▍巫
<br>東洲では能力者は<span>巫</span>と呼ばれている。存在するだけで犯罪者扱いのディスとは異なり、邪崇と呼ばれる怪物を退け、人々から尊敬される存在である。
黒環による狂厄汚染のない東洲で生まれた巫は、能力者のような精神汚染を比較的受けず、いつも先天的な霊感によって覚醒する。
その性質は影響を受けた狂厄天災と近い属性になる。
東洲はYFJも最新の技術も持たないが、巫は能力者の異能力と異なる、代々伝わってきた術式で邪崇に立ち向かうことができる。`,
];
