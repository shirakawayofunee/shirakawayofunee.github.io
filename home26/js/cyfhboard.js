const connections = [
  { from: 0, to: 1, label: "栽培、我が子のように大切にする、最も愛する部下", color: "#b2160b", dashed: false }, // L -> Severo (red)
  { from: 1, to: 0, label: "劣情、湿度高めの激重愛、求不得苦", color: "#b2160b", dashed: false }, // Severo -> L (blue)
  { from: 0, to: 2, label: "栽培、野放し", color: "#2980b9", dashed: false }, // L -> Jin
  { from: 2, to: 0, label: "尊敬", color: "#b2160b", dashed: false }, // Jin -> L
  { from: 0, to: 3, label: "栽培、教導", color: "#2980b9", dashed: false }, // L -> Ji
  { from: 3, to: 0, label: "敬愛", color: "#b2160b", dashed: false }, // Ji -> L
  { from: 0, to: 4, label: "やり返す、敵であり味方、複雑な協力関係", color: "#2980b9", dashed: true }, // L -> X
  { from: 4, to: 0, label: "敬慕の愛、利用", color: "#b2160b", dashed: true }, // X -> L
  { from: 0, to: 6, label: "元同僚、今は顧客", color: "#2980b9", dashed: true }, // L -> LY
  { from: 6, to: 0, label: "利用", color: "#2980b9", dashed: true }, // LY -> L
  { from: 6, to: 7, label: "リーダー", color: "#b2160b", dashed: false }, // LY -> DD
...
function createConnectionLabel(text, start, end, offsetX, offsetY) {
  ...
  rect.setAttribute("rx", window.innerWidth <= 576 ? "6" : "8");
