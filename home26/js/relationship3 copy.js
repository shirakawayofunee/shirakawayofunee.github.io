...
document.addEventListener('DOMContentLoaded', () => {
  ...
  var textArray = [
    'Lが何十年も育った弟子たちをすべて殺した。なぜなら、Lはその計画において欠かせない、唯一無二の存在だ。Lとの戦いの中で感情の亀裂が生じ、再び感情を取り戻し、Lに恋をする。<br>「君の命がもう尽きようとしてなければ、もっと穏やかな方法を選びたかった。でも、残念ながら私たちには時間がない。だから、思う存分抵抗しなよ…全部わかってる、全部受け入れるよ。たとえ私の触れた花が枯れる運命でも、君を生かさなきゃいけないんだ。」<br>XはLの人柄と行動を高く評価している。XはLの反逆精神と強い決断力に深く感銘を受け、羨望の念を抱きます。彼女はLが自由に規則を反逆し、信頼できる仲間に支えられてその行動を進めていることに強く惹かれます。Xにとって、Lは単なる駒に過ぎないわけではなく、祝福されるべき存在だと認識しています。Xの計画においてLは非常に重要な役割を担っており、表面的には対立しているように見える二人の協力も、最終的には同じ目標—反乱と自由—を達成するためのものです。',
    'Left Text 2',
