    ...
    characters: [
      {
        name: `（L）`,
        avatar: `img/dh/.png`,
        note: `子どもへの深い慈愛と責任感を胸に、いかなる逆境にあっても活路を切り開き、決して重圧をかけず、心配させまいと気丈に振る舞う師匠
        <br>（代わりに猫を。適切な表情差分がないため。）`
      },
      {
        name: `『Pansy』`,
        avatar: `img/dh/`,
      ...
      },
      {
        ...
        note: `『弱者』の主人公。今回は名前のみ登場。いずれ顔を見せるための予告となります。<br>
        Lが義人や賢者なら、局長は■■です。<br>
        「CP要素」についてですが、ご安心ください。義母攻め×娘婿受けという猟奇的な関係性ではありません。<br>
