  ...
  infoPanel: {
    ...
    現在は再編を経て7人のメンバーによって構成されている。`
      ...
      },
      {
        term: `GARDEN`,
        desc: `秘密組織
        組織メンバーのコードネームは、すべて花の名前に由来しています。
        工事中`
      },
      {
        term: `9th、銀蜘蛛`,
    ...
    characters: [
      {
        ...
        avatar: `img/dh/L24.png`,
        note: `「GARDEN」の主、裏社会を陰で牛耳る実力者。`,
        basicStats: `子供の感情の揺れに気づき、さりげなく解きほぐせる頼もしい大人。
...
`
      ...
      },
      {
        ...
        note: `27歳。表の顔は華道家
        `,
        basicStats: `敬语系角色、完全没体验过战争的Z时代，L在她这个年纪的时候，烦恼的是怎么把自己的肠子塞回去，L衷心地为孩子们体会不到“战争是属于全人类的伤口。”这件事而高兴。
        <br>生い立ち：（工事中）
  ...
  script: [
    ...
    },
    {
      ...
      voice: [
        ...
        { label: "日", path: "wav/JP/conversation24/vo_event_11031_28.wav" },
      ],
    },
    {
      type: `dialogue`,
    ...
    },
    {
      ...
      voice: [
        ...
        { label: "日", path: "wav/JP/conversation24/vo_event_11031_22.wav" },
      ],
    },
    {
      type: `dialogue`,
    ...
    },
    {
      ...
      voice: [
        ...
        { label: "日", path: "wav/JP/conversation24/vo_event_11031_16.wav" },
      ],
    },
    {
      type: `narration`,
    ...
    },
    {
      ...
      voice: [
        ...
        { label: "日", path: "wav/JP/conversation24/vo_event_11031_32.wav" },
      ],
    },
    {
      type: `dialogue`,
    ...
    },
    {
      ...
      voice: [
        ...
        { label: "日", path: "wav/JP/conversation24/vo_event_11031_17.wav" },
      ],
    },
    {
      type: `dialogue`,
    ...
    },
    {
      ...
      voice: [
        ...
        { label: "日", path: "wav/JP/conversation24/vo_event_11031_23.wav" },
      ],
    },
    {
      type: `dialogue`,
    ...
    },
    {
      ...
      voice: [
        ...
        { label: "日", path: "wav/JP/conversation24/给我笑一个.wav" },
      ],
    },
    {
      type: `dialogue`,
    ...
    },
    {
      ...
      voice: [
        ...
        { label: "日", path: "wav/JP/conversation24/vo_event_11031_20.wav" },
      ],
    },
    {
      type: `dialogue`,
    ...
    },
    {
      ...
      voice: [
        ...
        { label: "日", path: "wav/JP/conversation24/vo_event_11031_27.wav" },
      ],
    },
    {
      type: `dialogue`,
    ...
    },
    {
      ...
      voice: [
        ...
        { label: "日", path: "wav/JP/conversation24/好好想想怎么让业师开心.wav" },
      ],
    },
    {
      type: `narration`,
    ...
    },
    {
      ...
      avatar: `img/dh/armaf2.png`,
      name: `シーゲル`,
      text: `HUSHめ……西区から新都市まで、ずっと妨害してきやがった。まるでこちらの動きが見えているかのように……指揮しているのはあの能力者、シャーロームか……`
    },
    {
      type: `dialogue`,
      position: `left`,
    ...
    },
    {
      ...
      avatar: `img/dh/armaf2.png`,
      name: `シーゲル`,
      text: `もし全てがあの執行人の観測に基づいた計算だとしたら、もし彼女が何らかの方法で深層狂厄領域に潜入しているとしたら……彼女が何を見て、何をしでかすか、<ruby>我々<rt>福音地</rt></ruby>の想像も及ばない。`
    },
    {
      type: `dialogue`,
      position: `left`,
    ...
    {
      type: `narration`,
      text: `「業師」は歩み寄り、シーゲルに近づくと、片手をその傷口に突き刺した。`
    },
    {
      type: `dialogue`,
      position: `left`,
...
edge-02：ええ、頼んだわ。
    ...
    },
    {
      ...
      name: `シャーローム`,
      text: `（心の声）
      探しに来て、「Coquelicot」。きみなら、きっと私の期待を裏切らない……`
    }
