export default {
  ...
  infoPanel: {
    ...
    synopsis: `『Garofano』が「GARDEN」への忠誠は揺るぎない。数時間にわたる審問は進展せず、代理人は『Garofano』の罵倒以外何も得られなかった。<br>そこへXが「生きている『Garofano』の方が価値がある」と提案――『Garofano』を人質として連れ去れ、レオポルドから福音地の重要情報を引き出すという計画を立てた。代理人はその提案を認める。しかし、「レオポルド」の名を耳にした瞬間、『Garofano』は福音地から与えられた単瞳のルーンを起動。<br>ルーンの力が暴走し、彼女は一瞬で制御を失い、監禁を突破して屋敷から逃走し、大混乱を引き起った。`
  },
  script: [
    {
      type: `narration`,
    ...
    {
      type: `narration`,
      text: `（『Garofano』の脳は瀕死の状態に陥り、生前の記憶が走馬灯のように目の前で駆け巡る。）`
    },
    {
      type: `dialogue`,
      position: `left`,
    ...
    },
    {
      ...
      avatar: `img/dh/severo10.png`,
      name: `Severo`,
      text: `『Garofano』の中「私は自分のために生きている…もう宝物は私の手に入った…彼女たちを傷つけるなんてさせない…誰も私のとこを通させない…」`
    },
    {
      type: `narration`,
      text: `だが、そんな思いももはや意味がない。「狂厄」が彼女の体内で暴走し、『Garofano』の意識を徐々に奪っていく。`
    }
  ]
};
