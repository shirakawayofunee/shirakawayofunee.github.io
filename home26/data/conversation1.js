export default {
  ...
  infoPanel: {
    glossary: [
      {
        term: `BR-002`,
        desc: `新都市で発生した大規模な狂厄災害（黒環）の一つ。この動乱により周辺の情勢は大きく揺れ動いた。`
      },
      {
        term: `FAC`,
    ...
    synopsis: `BR-002の発生から百日あまり。徐々に安定を取り戻しつつあった新都市の裏で、要人を標的とした暗殺計画が静かに進行していた。エリカ邸の防衛線が突破される中、現場には巨大な盾を手にした一人のFAC特別ユニットが到着する。`
  },
  script: [
    {
      type: `narration`,
    ...
    {
      type: `narration`,
      text: `管理局長の望みどおり、地下勢力の多くは新都市から撤退し、東区で発生する狂厄事件も著しく減少。敵との直接的な衝突はさらに西区へと集約され、城邦の損害を最小限に抑える態勢が整いつつあった。FACは現在、黒環に対する第一防衛線の構築を進めている。`
    },
    {
      type: `narration`,
      text: `だが、その最中だった。\n新都市の治安官のもとに緊急情報が入った。城邦の要人数名が襲撃を受け、暗殺リストに名を連ねている可能性があるという。`
    },
    {
      type: `narration`,
    ...
    {
      type: `narration`,
      text: `黒雲が街を覆い、豪雨が迫る。そして、その幕開けを飾るのは――\n\nただ数人の哀れな人間による、滑稽な物語にすぎない。`
    },
  ]
};