export default {
  ...
  script: [
    ...
    },
    {
      ...
      name: `EDGE-04`,
      text: `（EDGE-04）<br>情勢があまりにも混乱している。西区は今、危険すぎるし、動揺が多すぎる。3月の当初の計画通り、直接浄化令を使うべきだった。02骸はSHP-13に併吞させ、我々のルールで一気に二つの脅威を浄化する。`
    },
    {
      type: `dialogue`,
      position: `left`,
      avatar: `img/dh/edge_04.jpg`,
      name: `EDGE-04`,
      text: `（EDGE-04）<br>こんな風に巨額を投じて制御不能な黒環を作り出し、西区は依然として混沌のままだ。我々の毎歩は危うい。当時の方案変更はあまりにも過激だった。X、彼女が――`
    },
    {
      type: `dialogue`,
      position: `left`,
    ...
    },
    {
      ...
      avatar: `img/dh/edge_04.jpg`,
      name: `EDGE-04`,
      text: `（EDGE-04）<br>どうやって鎮圧する？BR-002の状態は過去のどの黒環とも異なる。今、我々にできるのは溢れる汚染を辛うじて封鎖することだけだ。福音地の動きも厳重に警戒しないと。彼らの牧羊人もこの巨大黒環を見逃さないだろう。`
    },
    {
      type: `dialogue`,
      position: `left`,
