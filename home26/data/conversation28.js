export default {
  ...
  script: [
    ...
    {
      type: `narration`,
      text: `西区8月戦役が白熱する中、上庭は防御の固い地点を選び、豊富な対狂厄兵器と最強のHUSH精鋭部隊を配備した。一人の能力者に対する待遇としては、敬意すら感じるほどだ。`,
    },
    {
      type: `narration`,
      text: `だが、まったく無意味だった。`,
    ...
    {
      type: `narration`,
      text: `襲撃者に隠れる様子は一切ない。殺し屋は正面から堂々と現れ、秘密基地そのものを自らの狩り場へと変えた。悲鳴が絶え間なく響く。歩みを進める先で、動くもの、動こうとするもの全てが悉く排除されていく。`,
    },
    {
      type: `narration`,
      text: `今、業師がゆっくりと大広間へ入ってくる。その表情は平穏そのもので、彼女は軽く周囲を見渡した。`,
    },
    {
      type: `narration`,
      text: `執行人は彼女が近づくのを見つめている。黒石英が警戒して執行人の前に立ちはだかり、救援信号を密に発信しながら、その中心にエネルギーを収束させていく。`,
    },
    {
      type: `dialogue`,
      position: `left`,
    ...
    {
      type: `narration`,
      text: `4、5人のHUSH精鋭が危険を察知し、執行人の前に飛び出す。次の瞬間、紅い閃光が走り、彼らはまるで串刺しのように一瞬でコクリコに貫かれた。`,

    },
    {
      type: `narration`,
      text: `コクリコは全ての障害を粉砕し、真っ直ぐ執行人へと突き進む。その瞳は血のように赤く輝いている。`,
    ...
    {
      type: `narration`,
      text: `業師の足元には残骸が積み上がり、通ってきた道は鮮血で染まっている。手にした花の剣が砕けると、彼女はそれを無造作に捨て、うつむき加減に笑いながら呟いた。`,
    ...
    {
      type: `narration`,
      text: `生き残った2体のHUSH精鋭が彼女の丸腰を見て取り、好機とばかりに襲いかかる。`,
    },

    {
      type: `narration`,
      text: `だが、彼女に触れるより早く、彼らは貫かれ、砕かれ、崩れ落ちた。`,
    },
    {
      type: `narration`,
      text: `業師は彼らを踏みつけ、一歩一歩執行人へ近づいていく。`,
    ...
    {
      type: `narration`,
      text: `彼女が手を掲げると、足元の敗者たちの死体から赤色の花芽が抽出され、瞬く間に剣へと凝縮される。コクリコはそれを掴み、振り上げた。`,

    },
    {
      type: `narration`,
      text: `一斉に射出された青い光線と、投擲された結晶の棘が激突し粉砕される。舞い散る結晶の欠片の中を彼女は進む。その歩みを止めるものは何もない。`,
    ...
    },
    {
      ...
      voice: [
        ...
        { label: '日', path: 'wav/JP/conversation28/vo_event_11041_19.wav' },
      ]
    },
    {
      type: `dialogue`,
    ...
    {
      type: `narration`,
      text: `執行人の顔に、<span>ついに心からの笑</span>みが浮かんだ。`,
    },
    {
      type: `dialogue`,
      position: `left`,
      ...
      voice: [
        { label: '中', path: 'wav/CN/conversation28/vo_event_11041_27.wav' },
      ]
    },
    {
      type: `dialogue`,
