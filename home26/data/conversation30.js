export default {
  ...
  infoPanel: {
    ...
    characters: [
      ...
      },
      {
        ...
        note: `上庭の七代目執行人`,
        basicStats: `高き壁に閉じ込められ感情を奪われた囚人。
  ...
  script: [
    ...
    },
    {
      ...
      voice: [
        { label: '中', path: 'wav/CN/conversation30/vo_event_11043_118.wav' },
        { label: '日', path: 'wav/JP/conversation30/vo_event_11043_40.wav' },
      ]
    },
    ...
    },
    {
      ...
      name: `ミリア`,
      text: `（探偵の回想）
      真実に向き合うのは、そんなに難しいこと？探偵！`,
      voice: `wav/CN/conversation30/vo_event_11043_15.wav`,
    },
    {
      type: `dialogue`,
      position: `right`,
    ...
    },
    {
      ...
      voice: [
        { label: '中', path: 'wav/CN/conversation30/vo_event_11043_39.wav' },
        { label: '日', path: 'wav/JP/conversation30/voevent11043_1.wav' },
      ]
    },
    {
      type: `dialogue`,
    ...
    },
    {
      ...
      voice: [
        { label: '中', path: 'wav/CN/conversation30/vo_event_11043_33.wav' },
      ]
    },
    {
      type: `dialogue`,
    ...
    },
    {
      ...
      voice: [
        { label: '中', path: 'wav/CN/conversation30/vo_event_11043_64.wav' },
      ]
    },
    {
      type: `dialogue`,
      ...
      voice: [
        { label: '中', path: 'wav/CN/conversation30/vo_event_11043_120.wav' },
        { label: '日', path: 'wav/JP/conversation30/vo_event_11043_30.wav' },
      ]
    },    
    {
      type: `dialogue`,
      ...
      voice: [
        { label: '中', path: 'wav/CN/conversation30/vo_event_11043_31.wav' },
        { label: '日', path: 'wav/JP/conversation30/voevent11043_23.wav' },
      ]
    },
    {
      type: `dialogue`,
    ...
    },
    {
      ...
      voice: [
        { label: '中', path: 'wav/CN/conversation30/vo_event_11043_104.wav' },
        { label: '日', path: 'wav/JP/conversation30/vo_event_11043_31.wav' },
      ]
    },
    {
      type: `narration`,
    ...
    {
      type: `narration`,
      text: `シャーロームは壮大な殿堂が崩れ去るのを、向こう側の狂厄が雪崩れ込んでくるのを、神聖なルールがついに腐敗するのを見ていた。これこそが彼女の力。禁錮されず、歪曲されず、剥奪されない本心。`,
    ...
    },
    {
      ...
      text: `どきなさい！`,
      voice: [
        { label: '中', path: 'wav/CN/conversation30/vo_event_11043_3.wav' },
        { label: '日', path: 'wav/JP/conversation30/vo_event_11043_36.wav' },
      ]
    },
    {
      type: `narration`,
