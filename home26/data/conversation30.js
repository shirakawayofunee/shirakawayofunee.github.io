export default {
  ...
  script: [
    ...
    {
      type: `narration`,
      text: `業師はシャロームの目を見つめた。その空虚な瞳は、空虚であるがゆえに、今この瞬間だけは<span>真誠</span>に見えた。`
    },
    {
      type: `narration`,
    ...
    {
      type: `narration`,
      text: `シャロームは静かに彼女を見つめ、長い沈黙の後、<span>微笑</span>んで答えた。`
    },
    {
      type: `dialogue`,
      position: `left`,
    ...
    {
      type: `narration`,
      text: `執行人は止めなかった。崩壊する裂け目から蠢く光の触手が伸び、狂乱の光を投げかける。シャロームの顔に映る蝋人形のような微笑みには、どこか不気味な亀裂が走り、まるで悲願が達成されたかのようだった。`
    },
    {
      type: `dialogue`,
      position: `left`,
    ...
    {
      type: `narration`,
      text: `その光の中に、見慣れた笑顔がいくつも浮かんだ。彼女の花たちだ。抱きしめたい、守りたいと思った。本当なら、自分の『ガーデン』で安らかに眠りたかった。`
    },
    {
      type: `narration`,
    ...
    {
      type: `narration`,
      text: `彼女は剣を振るい光の中へと躍り込んだ。今や彼女の目と脳裏にはシャローム一人しか映っていない。`
    },
    {
      type: `narration`,
