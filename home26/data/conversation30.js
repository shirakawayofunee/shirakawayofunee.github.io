export default {
  ...
  infoPanel: {
    ...
    characters: [
      ...
      },
      {
        ...
        <span>Shalom</span>が本心からLと彼女の理想郷が、生き延びられるように、Lを一助けすることを選んだ。
        `
      },
      {
        name: `Chris｜探偵`,
  ...
  script: [
    ...
    },
    {
      ...
      voice: [
        { label: '中', path: 'wav/CN/conversation30/vo_event_11043_129.wav' },
        { label: '日', path: 'wav/JP/conversation30/vo_event_11043_56.wav' },
      ]
    },
    {
      type: `dialogue`,
