  ...
  infoPanel: {
    ...
    characters: [
      ...
      },
      {
        ...
        note: `カヴェンディッシュ家の執行官。`,
        basicStats: `新都市への避難を提案しつつ、キャンプの人々を任される。`,
        profile: `危険度：不明
        出身：新城
        能力：不明`
      },
...
……もう過ぎたことだ。ある程度動けるようになったら、こっちへ来て手伝って。人手が足りない。`
    ...
    },
    {
      ...
      avatar: `img/dh/sanji.png`,
      name: `サンジ`,
      text: `……新都市のクイン・グループが、砂海にいくつかの臨時居住区を提供してくれた。みんな、そこで一時的に身を隠せる。`
    },
    {
      type: `dialogue`,
      position: `left`,
...
新都市の誰かが見てる。誰かが——`
    ...
    },
    {
      ...
      position: `left`,
      name: `気落ちした難民`,
      text: `やめとけ。執行官がネットを遮断した。どこに流すつもりだ？仮に投稿できたとして、お前が言う良心的な新都市の連中は、声を上げる以外に何ができる？
...
カヴェンディッシュ家の人間が黒環の下で死ぬなど、あってはなりません。`
    ...
    },
    {
      ...
      avatar: `img/dh/matilda.png`,
      name: `マティルダ`,
      text: `ずっと私に新都市へ連れていけと言っていたでしょう？準備は整った。避難できる。`
    },
    {
      type: `narration`,
...
それから、お前だ。新都市の目、マティルダ・カヴェンディッシュ。一、二年の間に情勢がどう変わるか分からない。もしかしたら、お前が運命を変える政界の新星になるかもしれない。
