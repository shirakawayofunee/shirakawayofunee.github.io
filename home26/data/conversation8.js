export default {
  ...
  infoPanel: {
    ...
    characters: [
      ...
      両親の戦友に育てられたけど、養父母も113年3月のBR-002二次爆発でFACとして命を落とした。`,
      },
      {
        name: `Mireya`,
        name2: `探偵の妹`,
...
姉妹の間ではよく口げんかをするが、実は探偵のことを深く心配している。`,
  ...
  script: [
    ...
    },
    {
      type: `dialogue`,
      position: `left`,
      avatar: `img/dh/mourner.png`,
      name: `追悼者`,
      text: `子、一人で来たの？ご家族は?あっ…ごめんなさい、わたしったら…`
    },
    {
      type: `dialogue`,
      position: `left`,
    ...
    },
    {
      ...
      name: `探偵`,
      text: `ありがとう…他の人の代わりに来ただけだから、大丈夫だよ。`,
      voice: [
        { label: '日', path: 'wav/JP/conversation8/vo_event_11000_18.wav' },
      ]
    },
    {
      type: `dialogue`,
      ...
      text: `あたしは強いからね。`,
      voice: [
        { label: '日', path: 'wav/JP/conversation8/vo_event_11000_16.wav' },
      ]
    },
    {
      type: `dialogue`,
      ...
      voice: [
        ...
        { label: '中', path: 'wav/CN/conversation8/vo_event_11000_3.wav' },
      ]
    },
    {
      type: `dialogue`,
    ...
    {
      type: `narration`,
      text: `藍雨がしとしとと降り続く中、FACの追悼式はいつもこの絶妙な雰囲気に包まれる。BR-002が全城に拡散した汚染を浄化するため、そして逝去した英雄たちを悼むためだ。`
    },
    {
      type: `narration`,
      text: `探偵は陵園を出て、誰もいない場所へ歩き、傘を収め、空を見上げた。`
    },
    {
      type: `narration`,
      text: `藍雨が彼女の顔に当たり、流れとなって頬を伝い、涙と混ざり合い、狂厄の反応を刻む跡を残す。この痛みが自分を覚醒させてくれることを、彼女はどれほど願ったか。`
    },
    {
      type: `narration`,
    ...
    
    {
      ...
      name: `探偵`,
      text: `シャーローム姉さん！帰ってきたの？`,
      voice: [
        { label: '日', path: 'wav/JP/conversation8/vo_event_11000_1.wav' },
      ]
    },
    {
      type: `dialogue`,
      ...
      avatar: `img/dh/pc2.png`,
      name: `探偵`,
      text: `うわ…そんな大変だったんだ…もう…え？！地下の連中がまた何か企んでる？殺し屋が連続襲撃？なんて卑劣な奴ら、正面で勝てないからって裏で汚い手を使うなんて！`
    },
    {
      type: `dialogue`,
      position: `right`,
      avatar: `img/dh/pc2.png`,
      name: `探偵`,
      text: `…え？私が特派調査員？！本当にいいの？！`,
      voice: [
        { label: '日', path: 'wav/JP/conversation8/vo_event_11000_8.wav' },
      ]
    },
    {
      type: `dialogue`,
      ...
      avatar: `img/dh/pc2.png`,
      name: `探偵`,
      text: `うんうんうん、もちろんだよ！シャーローム姉さんの依頼なら絶対頑張ってやるよ！名探偵の未来をかけて、今すぐ出発する！`,
      voice: [
        { label: '日', path: 'wav/JP/conversation8/vo_event_11000_31.wav' },
      ]
    },
    {
      type: `narration`,
      text: `電話を切り、彼女は走り出した。数歩走っただけで、3メートルも跳び上がる勢いだ。`
    },
    {
      type: `dialogue`,
      position: `right`,
      avatar: `img/dh/pc2.png`,
      name: `探偵`,
      text: `お姉様の信頼と!光と正義のために!`,
      voice: [
        { label: '日', path: 'wav/JP/conversation8/vo_event_11000_22.wav' },
      ]
    },
    {
      type: `narration`,
      text: `N.F.113年8月8日、FAC総司令は西区戦線から新城に戻り、市議会に正式に<span>「BR-002黒環封鎖作戦」</span>の認可申請を提出。目的はBR-002周辺に反狂厄遮断網を構築し、黒環汚染の拡散を制限し、西区の環境を完全に安定させること。`
    },
    {
      type: `narration`,
      text: `FACの設立目的はDis城邦の守護であり、西区はDisの一部、西区の民は守られるべきDisの市民である。`
    },
    {
      type: `narration`,
      text: `彼らを決して見捨ててはならない。`
    },
    {
      type: `narration`,
      text: `この作戦はすでに上庭の支持を暫定的に得ており、資金、人力、組織権限などの具体的事項は、涅槃グループを含む多数の代表者による共同評価を経て、<span>8月15日</span>に最終審査が完了する予定である。`
    }
  ]
};
