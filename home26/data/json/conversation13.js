export default {
  ...
  script: [
    ...
    {
      type: `narration`,
      text: `彼女の視界には、手元に散らばる黒い金盞花の破片――いや、金盞花の形をした狂厄の汚染が見えた。それが彼女に悪夢の戦いを思い出させた。崩れた壁の下で、彼女は多くの死役と戦い、汚染された。`
    },
    {
      type: `narration`,
    ...
    },
    {
      ...
      avatar: `img/dh/smile0.png`,
      name: `業師`,
      text: `死役の山からこいつをせっかく引っ張り出したのに、同じ境遇なら分かり合えると思ったんだろ？でも、相手には君がただのクズに見える。せっかくの好意が無駄だったね。`
    },
    {
      type: `dialogue`,
      position: `left`,
