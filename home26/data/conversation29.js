...
それらは隙間の向こうから、現実と狂厄を隔てるギャップを引き裂き、怒涛のように押し寄せる。`,
  ...
  infoPanel: {
    ...
    現在は再編を経て7人のメンバーによって構成されている。`,
      ...
      {
        term: `GARDEN`,
        desc: `一个擅长潜伏匿迹的禁闭者杀手组织，成员大部分接受过完整的战斗训练，危险度极高。
        ▍ 组织信息
      ...
      {
        term: `能力者`,
        desc: `感染狂厄后，个体会沉浸于狂躁、纵欲、偏执等极端情绪，出现体能的异常提升及外表的异变。某些拥有极其强大的精神意志的狂厄感染者会觉醒为拥有超越常人力量的能力者。
        <br>公众对能力者的态度并不友好(也就是不能暴露在公众面前的身份)
