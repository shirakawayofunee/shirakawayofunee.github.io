export default {
  ...
  script: [
    ...
    {
      type: `narration`,
      text: `そう言うと、彼女は素手でシャーロームの胸を突き刺した。血が滲んだが、相手は痛みの表情を一切見せなかった。逆に、虚空から鋭い青い光の刺が業師の手の甲を貫いた。`,
      voice: [
        { label: '中', path: 'wav/CN/conversation29/vo_event_11042_53.wav' },
        { label: '日', path: 'wav/JP/conversation29/vo_event_11042_7.wav' },
      ]
    ...
    {
      type: `narration`,
      text: `それはシャーロームの力ではなく、この場を超える、もっと高次のルールだった。だが、業師は動じなかった。`,
      voice: [
        { label: '中', path: 'wav/CN/conversation29/vo_event_11042_53.wav' },
        { label: '日', path: 'wav/JP/conversation29/vo_event_11042_7.wav' },
      ]
    ...
    {
      type: `narration`,
      text: `業師は再びシャーロームに視線を戻す。このシャーロームの体には何の痕跡もなく、平然としている。`,
      voice: [
        { label: '中', path: 'wav/CN/conversation29/vo_event_11042_53.wav' },
        { label: '日', path: 'wav/JP/conversation29/vo_event_11042_7.wav' },
      ]
    ...
    },
    {
      ...
      avatar: `img/dh/x6.png`,
      name: `シャーローム`,
      text: `私は<span>七代目シャーローム</span>。上庭は私の感情を切り離し、裂け目の向こう側へと送りました。そうすることで、純粋理性となった私は前線に安定して留まることができ、感性の方は狂厄の深淵へと潜り、世界と人の心の変化を観測しているのです。`,
      voice: [
        { label: '中', path: 'wav/CN/conversation29/vo_event_11042_53.wav' },
        { label: '日', path: 'wav/JP/conversation29/vo_event_11042_7.wav' },
      ]
    ...
    },
    {
      ...
      avatar: `img/dh/impatient.png`,
      name: `業師`,
      text: `だったら君らだけで抱き合って地獄へ落ちなさいよ！他人を巻き込むんじゃないわよ！！`,
      voice: [
        { label: '中', path: 'wav/CN/conversation29/vo_event_11042_53.wav' },
        { label: '日', path: 'wav/JP/conversation29/vo_event_11042_7.wav' },
      ]
