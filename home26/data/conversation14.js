export default {
  ...
  script: [
    ...
    {
      type: `narration`,
      text: `09/08<br>行動進捗更新：連続する悪質な襲撃事件により、封鎖行動は抵抗に直面。一部議員や涅槃などの協力者が本計画を支持せず、草案の初審は失敗。<br>内部情報部門による草案の再審査通過率は楽観的でない。<br>リスク対策：新都市で連続襲撃事件が発生。総指揮部は事件の進捗を注視し、治安支援小隊を派遣。封鎖行動を妨害するリスクを早期に排除する。<br>内審摘要：002黒環防御網構築工事は、多方面の利害と巨額投資を伴い、一定の抵抗がある。ただし、最近の襲撃事件が他勢力による意図的な妨害の可能性は排除できない。再審査の進捗を阻む意図があると推測。`
    },
    {
      type: `narration`,
      text: `10/08<br>行動進捗更新：総司令は新都市に自ら赴き、草案再審査会議に出席予定。`
    }
  ]
};
