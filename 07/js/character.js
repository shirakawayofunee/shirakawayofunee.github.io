let characterMsg = [

  {
    ...
    check: "1c.png",
    title: "1t.png",
    str: "工事中<br>能力者。犯罪組織の主宰者であり、部下たちから恐れられ、崇拝されている存在。<br>童顔(不老)、実年齢不明。<br>艶やか、常に世を拗ねるような微笑を浮かべている。好き嫌いが激しく、享楽主義者で実用も重んじる、細やかで優しい一面も持っている。<br>落ち着き払った自信に満ちていて、自信かつ優雅な態度を保ち、性格は八方巧み。夹缝中的最强者，将上庭与地底的斗争视作狗咬狗。当前的目标是给自己的下属们寻求新的安全居所。(1/3)<br>",
  ...
  },
    {
      ...
      check: "2c.png",
      title: "2t.png",
      str: "工事中<br>能力者。<br>（SとLの初対面）<br>界隈内で数少ない有能な殺し屋として、Lのもとに弟子入りしたがる者は後を絶たず、みな彼女の名声に惹かれ、立派な後ろ盾を得ようと目論んでいる。だが、実際にLに教えを受ければ、疲れや苦しみ、傷つきから死ぬまで至り、どんな目に遭うかは各々の定め。だから、Lが本気で受け入れた弟子はほんのわずかだ。<br>Lは手を振って、猫や犬を呼ぶように気軽に人を呼び寄せた。Sは素直に従い、丁寧に礼をして「師匠」と呼んだ。<br>Sの謙虚な態度の下に抑えきれない憎しみが宿った瞳を見て、Lは笑った。「今の君の目、気に入ったよ。ストレートで、率直で、生きる欲望に満ち溢れている…惨めだけと運良く、愚かだけどどこか冴えていて、脆くも確固たる情熱を抱いてる。」<br>Lは████の方へ振り返り、「この子、いただくよ」と告げた。<br>(1/3)",
    ...
    },
    {
      ...
      check: "5c.png",
      title: "5t.png",
      str: "工事中<br>36岁，殺し屋。能力者。为了延长寿命的情报，伪装成附近的裁缝接近X。<br>对组织首领（L）有着近乎信徒般的狂热信仰，<br>「この世には、私たちを受け入れてくれる場所がある。理解してくれる人がいる。彼女はあなたを導き、残酷な復讐の道を支えてくれる。その気持ちさえあれば、私があなたを彼女に会わせてあげる。」<br>H「あなたが言うその人は、あの雇い主？それとも、組織のリーダー？」<br>「それは、私がやっと手に入れた新しい家族だよ。」<br>「もう二度と、誰にも私の大切なものを傷つけさせない。かつての私は復讐のためにすべてを捧げた。今は未来を守るため、その倍の力を尽くす。」<br>(3/3)",
    ...
    },
    {
      ...
      check: "6c.png",
      title: "6t.png",
      str: "工事中<br>能力者。廃棄期限まであと一ヶ月しかない人造人は、上庭を裏切る準備をしており、自身を廃棄から免れるための計画を実行中です。<br>腹黒く鬼畜で、目的のためには手段を選ばず、自らも含めた犠牲を厭わないほどです。Lの側近の重要人物を全て殺害した。計画においてLは不可欠な存在であった。Lとの戦いの中で感情の亀裂が生じ、再び感情を取り戻し、Lに恋をする。<br>XはLの人柄と行動を高く評価している。<br>「——使用期限内に、こっそり壊れてしまった道具にすぎないよ。」<br>「これが君が命と引き換えに得た力なんだ。流れるすべての未来を犠牲にして、絶対的な強さと自由を手に入れたんだ。ここまで辿り着けるのは君だけだ。本当に見事だ。君がこれほどまでに強く反骨精神を持っていてくれてありがとう……君なら勝てると分かっていたよ。」",
    ...
    },
    {
      ...
      check: "7c.png",
      title: "7t.png",
      str: "工事中<br>能力者。Lの弟子の一人で、数年前にある理由で離反した。<br>今の外部の大混乱で、依頼人として戻り、Lに助けを懇願している。",
    ...
    },
    {
      ...
      check: "8c.png",
      title: "8t.png",
      str: "工事中<br>「福音地」のリーダー、████。<br>Lの元上司であり、深い関係がある。それはまた別の長い物語だ。<br>メンバー同士にケアなど一切なし、互いに独立し、生死は自己責任。<br>彼らを一つに結びつけているのは、ある種の宿願である。それに身を捧げることはむしろ名誉とされている。<br>「また会えて本当に嬉しいよ。君に出会った時もこうやって連れて帰ったんだよね。また一緒に来てくれる？君の裏切りに気を悪くした人たちのほとんどはもう犠牲になって、今ならもう一度チャンスをあげられるよ。」",
    ...
    },
    {
      ...
      check: "9c.png",
      title: "9t.png",
      str: "工事中<br>上庭からXを協力（監視）するために派遣された代理人。<br>Sの尋問中、逃げられてしまった。<br>冷酷で機械的、典型的な上庭の官僚像を体現しており、<br>任務の効率を最優先し、一般人の命や感情を軽視する。",
    ...
    },
    {
      ...
      check: "10c.png",
      title: "10t.png",
      str: "工事中<br>「福音地」的实验品，被上庭抢走后投入使用",
