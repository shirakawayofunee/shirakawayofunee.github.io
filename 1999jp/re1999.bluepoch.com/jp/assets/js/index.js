  ...
  $.extend(App.prototype, {
    ...
    handleRookieSwitch: function (event) {
      ...
      if (this.rookieFlag === $(target).data("flag")) {
        ...
        this.audio.pause();
        $(".media-audio").removeClass("curr");
        console.log($(target).data("flag"));
       if(this.rookieFlag ==0){
          $(".wrap-state").css("right","5.25rem")
          $(".wrap-media").css("right","14.5rem")
          $(`.media-video`).show();
        }else if(this.rookieFlag ==1){
          $(".wrap-state").css("right","8.25rem")
          $(".wrap-media").css("right","24.5rem")
          $(`.media-video`).hide();
        }else{
          $(".wrap-state").css("right","5.25rem")
          $(".wrap-media").css("right","24.5rem")
    ...
    handleSwitch: function (event) {
      ...
      console.log(src);
      if (
        src == `./assets/img/second/1-2.png` ||
        src == `./assets/img/second/3-2.png`
      ) {
        $(`.part2 .wrap-rookie`).css("background-position", "43% 50%");
      }else if(src == `./assets/img/second/2-2.png`){
        $(`.part2 .wrap-rookie`).css("background-position", "40% 50%");
      } else {
        $(`.part2 .wrap-rookie`).css("background-position", "50% 50%");
      }
